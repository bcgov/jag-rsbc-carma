...
APP_NAME = 'api'
PROJECT_PREFIX = "jag-rsbc"

// You shouldn't have to edit these if you're following the conventions
SLACK_DEV_CHANNEL="#road-safety"
SLACK_MAIN_CHANNEL="#road-safety"
SLACK_PROD_CHANNEL="road-safety"
...
environments = [
  dev:new AppEnvironment(name:'Development',tag:'dev',url:'https://dev.jag.gov.bc.ca/rsbc-carma/'),
  test:new AppEnvironment(name:'Test',tag:'test',url:'https://test.jag.gov.bc.ca/rsbc-carma/'),
  prod:new AppEnvironment(name:'Prod',tag:'prod',url:'https://dev.jag.gov.bc.ca/rsbc-carma/')
]
