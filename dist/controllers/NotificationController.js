...
var NotificationController = /** @class */ (function (_super) {
    ...
    NotificationController.prototype.sendNotification = function (model) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                console.log(model);
                return [2 /*return*/, this.serviceInstance.sendNotificationEvent(model)];
            });
        });
    };
    __decorate([
    ...
    NotificationController = __decorate([
        ...
        authentication_1.Security('basic'),
        typescript_ioc_1.AutoWired
    ], NotificationController);
    return NotificationController;
}(ControllerBase_1.default));
exports.NotificationController = NotificationController;
//# sourceMappingURL=../../src/dist/controllers/NotificationController.js.map